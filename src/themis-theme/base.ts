...
import themeIviplay from "./theme-iviplay";
...
export abstract class BasePage{
  ...
  constructor(injector: Injector) {
    ...
    this.today = new Date()
    this.beforeday = new Date("2023-11-01")
    this.beforeday.setDate(this.today.getDate() - 7)
    ...
    else if(localStorage.getItem('theme') === 'iviplay') this.theme = themeIviplay;
    else this.theme = themeIviplay;
  }
