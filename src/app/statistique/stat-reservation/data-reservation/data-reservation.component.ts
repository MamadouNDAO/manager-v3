...
import {ModelAlarme, ModelCardFlux, ModelListConnexion, ModelStatUsage} from "../../../Model/ModelData";
...
export class DataReservationComponent extends BasePage implements OnInit, AfterViewInit {
  @Input() hauteurTab: string = "marg-t-20"
  @Input() activeFiltre: boolean = true;
  @Input() stats: ModelStatUsage[] = this.fixture.statReservation
  alarmes: ModelAlarme[] = []
